...
User.create!(email: "marco@123.com", password: "12345678", first_name: "Marco",
    ...
    role: "Full Stack Web Developer", company_name: "MammaMia Limited", address: "Westminster", gender: "male", student: false, company_type: "Start-up", company_size: 10, funding_stage: "Series-A", hq_location: "London", bio: Faker::Quote.famous_last_words)
...
User.create!(email: "louis@123.com", password: "12345678", first_name: "Louis",
    ...
    role: "Full Stack Shifu", company_name: "Windsor Castle", address: "Southwark", gender: "male", student: false, company_type: "Enterprise", company_size: 5000, funding_stage: "Post-IPO", hq_location: "California", bio: Faker::Quote.famous_last_words)
...
User.create!(email: "ife@123.com", password: "12345678", first_name: "Ife",
    ...
    role: "Frontend Master", company_name: "Le Dragon", address: "Lambeth", gender: "male", student: false, company_type: "Scale-up", company_size: 250, funding_stage: "Series-C", hq_location: "Berlin", bio: Faker::Quote.famous_last_words)
...
User.create!(email: "raeesa@123.com", password: "12345678", first_name: "Raeesa",
    ...
    role: "Full Stack Angel", company_name: "Greenrake Heaven", address: "Hackney", gender: "female", student: false, company_type: "Scale-up", company_size: 500, funding_stage: "Series-D", hq_location: "Rome", bio: Faker::Quote.famous_last_words)
...
User.create!(email: "phelim@123.com", password: "12345678", first_name: "Phelim",
    ...
    role: "St. Backend Developer", company_name: "Guinness Storehouse", address: "Greenwich", gender: "male", student: false, company_type: "Start-up", company_size: 5, funding_stage: "Pre-Seed", hq_location: "Dublin", bio: Faker::Quote.famous_last_words)
...
User.create!(email: "carly@123.com", password: "12345678", first_name: "Carly",
    ...
    role: "Junior Fullstack Developer", company_name: "JP Morgan", address: "Chelsea", gender: "female", student: false, company_type: "Enterprise", company_size: 1000, funding_stage: "Post-IPO", hq_location: "London", bio: Faker::Quote.famous_last_words)
...
User.create!(email: "johan@123.com", password: "12345678", first_name: "Johan",
    ...
    role: "Front-end Developer", company_name: "Paddle", address: "Kensington", gender: "male", student: false, company_type: "Start-up", company_size: 25, funding_stage: "Series-B", hq_location: "Berlin", bio: Faker::Quote.famous_last_words)
